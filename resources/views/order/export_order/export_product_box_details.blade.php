								...
								<div class="row row-sm ">
									<div class=" col-xl-5 col-lg-12 col-md-12">
										<div class="preview-pic tab-content">
										  <div class="tab-pane active" id="pic-1"><img src="http://coffeezone.website/Attachments/{{ $product[0]->id }}/{{ $product[0]->image_name }}" width="250"  height="250" alt="image"/></div>
				...
				@foreach ($detailProduct as $x)
					<div class="col-lg-6">
						...
						@if($x->box_image_name!=null)
										  <div  id="pic-1"><img src="https://coffeezone.website/Attachments/Box/mybox{{$x->box_id}}/{{$x->box_image_name}}" width="400pix"  height="90pix" alt="image"/></div>
										 
										
										@else
										<div  id="pic-1"><img src="https://coffeezone.website/assets/img/add_image.png" width="400pix"  height="90pix" alt="image"/></div>
